...
export const twoBranchesInTheEnd: WorkflowStateData = {
  StartAt: 'StartEvent',
  States: {
    StartEvent: {
      Type: 'Task',
              ...
              Branches: [
                {
                  ...
                  States: {
                    ...
                    RejectOneType: {
                      Type: 'Task',
                      End: true,
                      Comment: 'Reject One Type',
                      Parameters: {
                        taskType: 'task',
                      },
                      Branches: [
                        {
                          StartAt: 'SlackMessage',
                          States: {
                            SlackMessage: {
                              Type: 'Pass',
                              Next: 'SlackMessage1',
                        ...
                        {
                          StartAt: 'SkypeMessage',
                          States: {
                            SkypeMessage: {
                              Type: 'Pass',
                              End: true,
                              Comment: 'Skype message',
                              Parameters: {
                                taskType: 'pass',
                              },
                            },
                        ...
                        // {
                        //   StartAt: 'TelegramMessage',
                        //   States: {
                        //     TelegramMessage: {
                        //       Type: 'Pass',
                        //       End: true,
                        //       Comment: 'Telegram message',
                        //       Parameters: {
                        //         taskType: 'pass',
                        //       },
                        //     },
