...
export const workflowTestData0: WorkflowStateData = {
  StartAt: 'StartEvent',
  States: {
    StartEvent: {
      Type: 'Task',
...
export const workflowTestData1: WorkflowStateData = {
  StartAt: 'StartEvent',
    States: {
  StartEvent: {
    Type: 'Task',
...
export const workflowTestData2: WorkflowStateData = {
  StartAt: 'StartEvent',
  States: {
    StartEvent: {
      Type: 'Task',
...
export const workflowTestData3: WorkflowStateData = {
  StartAt: 'StartEvent',
  States: {
    StartEvent: {
      Type: 'Task',
...
export const workflowTestData4: WorkflowStateData = {
  StartAt: 'StartEvent',
  States: {
    StartEvent: {
      Type: 'Task',
...
export const workflowTestData5: WorkflowStateData = {
  StartAt: 'StartEvent',
  States: {
    StartEvent: {
      Type: 'Task',
